...
function FullScreenLoading() {
  return (
    <div className="fixed inset-0 bg-[#F7F8FB] z-50 flex flex-col items-center justify-center">
      ...
      <p className="text-xl font-semibold text-gray-700 mt-8">Loading bond details...</p>
...
function WalletStrip({ walletAddress }: { walletAddress: string }) {
  ...
  return (
    <motion.div
      {...fadeIn}
      className="rounded-2xl border border-gray-200/80 bg-white/80 backdrop-blur-sm shadow-sm overflow-hidden"
    >
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between p-4 sm:p-5">
        <div className="flex items-center gap-3 text-sm">
          <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-gradient-to-br from-[#5B50D9] to-[#8B5CF6] shadow-sm">
            <Wallet className="w-4 h-4 text-white" strokeWidth={2} />
          </span>
          <div className="flex flex-col sm:flex-row sm:items-center gap-2">
            <span className="font-semibold text-gray-900 text-sm">Your wallet address:</span>
            <code className="px-3 py-1.5 rounded-lg bg-gray-50/80 text-gray-700 border border-gray-200/60 break-all font-mono text-sm tracking-wide">
              {walletAddress}
            </code>
          </div>
        </div>
        <div className="flex items-center gap-2">
          <button
            onClick={copy}
            className="group inline-flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium bg-white border border-gray-300 hover:border-gray-400 hover:shadow-md transition-all duration-200"
            aria-label="Copy wallet address"
          >
            <Copy className="w-4 h-4 text-gray-600 group-hover:text-gray-700" />
            <span className="text-gray-700 group-hover:text-gray-900">{copied ? "Copied" : "Copy"}</span>
          </button>
    ...
    <div className="flex min-h-screen bg-gradient-to-br from-gray-50/80 via-blue-50/30 to-indigo-50/20">
      ...
      <main className="flex-1 min-w-0 p-4 sm:p-6 lg:p-8">
        ...
        <motion.section
          ...
          className="mt-6 rounded-3xl border border-gray-200/80 bg-white/80 backdrop-blur-sm px-6 sm:px-8 py-7 shadow-sm"
        >
          {/* Header */}
          <div className="flex items-center gap-3 mb-8">
            <button
              onClick={() => router.back()}
              className="inline-flex items-center justify-center h-10 w-10 rounded-xl hover:bg-gray-100/80 transition-colors group"
              aria-label="Go back"
              type="button"
            >
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">Complete overview and investment details</p>
            </div>
          </div>
          ...
          >
            ...
            <div className="xl:col-span-2 space-y-6">
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="relative h-16 w-16 rounded-2xl border-2 border-white bg-white grid place-items-center shadow-lg">
                    <Image src="/RSEB.png" alt="Issuer" width={36} height={36} className="rounded-lg" />
                    <span className="absolute -bottom-1 -right-1 h-4 w-4 rounded-full ring-2 ring-white bg-emerald-500" />
                  </div>
              ...
              >
                <div className="bg-white rounded-2xl border border-gray-200/80 p-5 shadow-sm hover:shadow-md transition-shadow">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="text-sm font-semibold text-gray-700 mb-1">Face Value</h3>
                ...
                <div className="bg-white rounded-2xl border border-gray-200/80 p-5 shadow-sm hover:shadow-md transition-shadow">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="text-sm font-semibold text-gray-700 mb-1">Total Units</h3>
                      <p className="text-xl font-bold text-gray-900">{Number(bond.tl_unit_offered) / 10}</p>
                    </div>
                  </div>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="bg-white rounded-2xl border border-gray-200/80 p-5 shadow-sm hover:shadow-md transition-shadow">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="text-sm font-semibold text-gray-700 mb-1">Maturity Date</h3>
              ...
              <motion.div
                variants={staggerChildren}
                className="bg-gradient-to-br from-amber-50/80 to-orange-100/50 rounded-2xl border border-amber-200/60 p-6 shadow-sm"
              >
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                  <div className="flex-1">
                    <h3 className="text-lg font-bold text-amber-900 mb-2">Subscription Period</h3>
                    <div className="flex items-center gap-3">
                      <div className="flex items-center gap-2 bg-white/80 px-3 py-1.5 rounded-lg border border-amber-200/60">
                        <Clock className="w-4 h-4 text-amber-600" />
                        <span className="text-sm text-amber-800 font-medium">Time Remaining</span>
                      </div>
                  ...
                  <button
                    className="bg-gradient-to-br from-[#5B50D9] to-[#8B5CF6] text-white px-8 py-3.5 rounded-xl font-bold hover:from-[#4a40c8] hover:to-[#7c51e0] transition-all duration-200 shadow-lg shadow-[#5B50D9]/20 hover:shadow-xl hover:shadow-[#5B50D9]/30"
                ...
                {subErrorGlobal && (
                  <div className="mt-4 p-3 bg-red-50 border border-red-200 rounded-lg">
                    <p className="text-sm text-red-700 text-center font-medium">{subErrorGlobal}</p>
                  </div>
                )}
              </motion.div>
            </div>
            ...
            >
              {/* About Section */}
              <div className="bg-white rounded-2xl border border-gray-200/80 p-6 shadow-sm h-full">
                <div className="flex items-center gap-3 mb-4">
                  <BarChart3 className="w-5 h-5 text-gray-700" />
                  <h3 className="text-lg font-bold text-gray-900">About this Bond</h3>
                </div>
                ...
                {/* Specifications */}
                <div className="mt-6">
                  <h4 className="text-sm font-semibold text-gray-800 mb-3">Bond Specifications</h4>
                  <div className="space-y-3">
                    <div className="flex justify-between items-center py-2 border-b border-gray-100">
                      <span className="text-sm text-gray-600">Bond Name</span>
                      <span className="text-sm font-medium text-gray-900">{bond.bond_name}</span>
                    </div>
                    <div className="flex justify-between items-center py-2 border-b border-gray-100">
                      <span className="text-sm text-gray-600">Bond Symbol</span>
                      <span className="text-sm font-medium text-gray-900">{bond.bond_symbol}</span>
                    </div>
                    <div className="flex justify-between items-center py-2 border-b border-gray-100">
                      <span className="text-sm text-gray-600">Issuer</span>
                      <span className="text-sm font-medium text-gray-900">{bond.organization_name}</span>
                    </div>
                    <div className="flex justify-between items-center py-2">
                      <span className="text-sm text-gray-600">Interest Rate</span>
                      <span className="text-sm font-semibold text-emerald-600">{bond.interest_rate}% p.a.</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        {subSuccess && (
          <div className="fixed inset-0 z-[120] flex items-center justify-center bg-black/60 backdrop-blur-sm">
            <motion.div
              ...
              className="w-[90%] max-w-md rounded-2xl bg-white shadow-2xl border border-gray-200/80 p-6"
            >
              <div className="text-center mb-4">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-1">Subscription Successful! 🎉</h3>
                <p className="text-sm text-gray-600 mb-4">
                  Your bond investment has been processed successfully. The allocation will be reflected in your portfolio shortly.
                </p>
              </div>
              {subTxDigest && (
                <div className="bg-gray-50 rounded-xl p-3 mb-4">
                  <p className="text-xs text-gray-500 mb-1 font-medium">Transaction Digest</p>
                  <code className="text-xs text-gray-700 break-all font-mono">{subTxDigest}</code>
                </div>
              )}
              <div className="flex gap-3">
                <button
                ...
                <button
                  className="flex-1 px-4 py-2.5 rounded-xl bg-gradient-to-br from-[#5B50D9] to-[#8B5CF6] text-white text-sm font-semibold hover:from-[#4a40c8] hover:to-[#7c51e0] transition-all"
