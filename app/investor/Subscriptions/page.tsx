...
function FullScreenLoading() {
  return (
    <div className="fixed inset-0 bg-[#F7F8FB] z-50 flex flex-col items-center justify-center">
      ...
      <p className="text-xl font-semibold text-gray-700 mt-8">Loading pending subscriptions...</p>
      <p className="text-gray-500 mt-2">Please wait while we fetch your subscription information</p>
...
function StatusBadge({ value }: { value: string }) {
  ...
  return (
    <span
      className={`inline-flex items-center rounded-full px-2.5 py-1 text-[12px] font-medium ring-1 ring-inset ${map[value] || "bg-gray-50 text-gray-700 ring-gray-200"}`}
    >
      {value}
    </span>
  );
      ...
      <main className="flex-1 min-w-0 p-4 sm:p-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            {items.length > 0 && (
              <div className="bg-white rounded-xl px-4 py-2 border border-gray-200">
                ...
                subscription(s) awaiting allocation
              </div>
            )}
          </div>
        </motion.header>
          ...
          {items.length > 0 ? (
              ...
              <div className="hidden lg:block">
                <div className="p-1">
                  <table className="w-full text-left bg-white">
                    <caption id="subscriptions-title" className="sr-only">
                      Pending subscriptions
                    </caption>
                    <thead>
                        ...
                        >
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                <span className="text-[15px] font-semibold text-gray-900 block">
                                  {subscription.bond.bond_name}
                                </span>
                                <span className="text-[13px] text-gray-500">
                                  {subscription.bond.organization_name} • {subscription.bond.bond_symbol}
                                </span>
                              </div>
                            </div>
                          </td>
                          ...
                          <td className="py-4 px-3">
                            <span className="text-[14px] font-medium text-gray-900">
                              {nf.format(Number(subscription.committed_amount) / 10)} units
                            </span>
                          </td>
                          ...
                          <td className="py-4 px-3">
                            <span className="text-[14px] font-medium text-gray-900">
                              {subscription.bond.interest_rate}% p.a.
                            </span>
                          </td>
                    ...
                    >
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-[13px] text-gray-600">
                              {subscription.bond.organization_name}
                            </p>
                          </div>
                        </div>
                        <StatusBadge value="Pending" />
                      ...
                      <div className="grid grid-cols-2 gap-4 text-[13px]">
                        ...
                        <div className="col-span-2 space-y-1">
                          ...
                          <p className="text-gray-900 font-medium">
                            {subscription.bond.interest_rate}% per annum
                          </p>
                        </div>
                        <div className="col-span-2 space-y-1">
                          <p className="text-gray-500">Bond Symbol</p>
                          <p className="text-gray-900 font-medium">
                            {subscription.bond.bond_symbol}
                          </p>
                        </div>
                      </div>
                    </div>
            ...
            <div className="p-12 text-center">
              ...
              <p className="text-gray-600 max-w-sm mx-auto">
                You don't have any pending bond subscriptions at the moment.
              </p>
            </div>
          )}
        </motion.section>
        ...
        {items.length > 0 && (
          ...
          >
            ...
            <div className="bg-white rounded-xl px-4 py-2 border border-gray-200">
              <span className="font-medium text-amber-600">{items.length}</span>{" "}
              pending allocation
            </div>
          </motion.div>
        )}
